  ...
  const pricingTiers = [
    ...
    },
    {
      ...
      features: [
        ...
        { name: "Performance simulator", included: true },
        { name: "Discord bot", included: false },
      ],
      ctaText: "Subscribe",
    },
    {
      ...
      features: [
        ...
        { name: "Discord bot notifications", included: true },
        { name: "Telegram AI (Elite only)", included: false },
      ],
      isPopular: true,
      ctaText: "Subscribe",
    },
    {
      ...
      features: [
        ...
        { name: "Telegram AI Assistant", included: true },
